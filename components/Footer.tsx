export default function Footer() {
  ...
  return (
    <footer className="relative w-full mt-24 overflow-hidden">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-[120px] bg-violet-900/20 blur-[80px] pointer-events-none" />

      <div className="relative backdrop-blur-md bg-[#09090f]/60 py-10 px-4">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex flex-col items-center md:items-start gap-1">
            ...
            <p className="text-gray-500 text-xs">
              Mahasiswa • UI Designer • Kreator Digital
            </p>
          </div>
          ...
          <a
            href="#home"
            className="group flex items-center gap-2 px-4 py-2 rounded-xl glass-card glass-card-hover text-gray-400 hover:text-white text-sm font-semibold transition-all duration-300"
          >
            <svg
